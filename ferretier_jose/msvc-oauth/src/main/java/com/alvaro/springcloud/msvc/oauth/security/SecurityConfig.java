...
public class SecurityConfig {
    ...
    SecurityFilterChain defaultSecurityFilterChain(HttpSecurity http,
                                                   org.springframework.security.authentication.AuthenticationManager authManager) throws Exception {
    ...
    RegisteredClientRepository registeredClientRepository() {
        RegisteredClient oidcClient = RegisteredClient.withId(UUID.randomUUID().toString())
                ...
                //.postLogoutRedirectUri("http://127.0.0.1:8090/logout") //esto es opcional
                .authorizationGrantType(AuthorizationGrantType.CLIENT_CREDENTIALS) //para el postman
    ...
    AuthorizationServerSettings authorizationServerSettings() {
        return AuthorizationServerSettings
                .builder()
                //.issuer("http://127.0.0.1:9100") local
                .issuer("http://localhost:9100")
                //.issuer("http://msvc-oauth:9100") docker
                .build();
    }
